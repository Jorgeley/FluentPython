...
@decorator2
def target2():
    print("target2")  # now that decorator2 returns the decorated function, both codes execute
...
"""
built-in decorators: python comes with some useful standard decorators like @functools.*
...
"""
Another good built-in decorator is @singledispatch, it makes a function as generic,
it can be called in different manners, like a overloaded method in OOP
"""
import html, numbers
...
def _(text):  # the name of the function is irrelevant and it's a good practice to make this clear
...
"""
Decorators with parameters: you can have a function with parameters to be used by
an inner function (the actual decorator), like a decorator factory
"""
registry = set()
...
def register(active=True):  # this is the decorator factory
    ...
    return decorate  # returning the decorator since register() is the factory of decorators
...
from designpatterns.Strategy_DesignPattern import pedidoZe
